...
export class ServiceService {
  ...
  loginCusto(email:any,password:any):any{
    return this.httpClient.get('Stock/webapi/myresource/loginUser/' + email + '/'+ password).toPromise();
  }
  
  registerCust(user : any) : any { 
    return this.httpClient.post('Stock/webapi/myresource/regUser' , user);
  }

  getNse(date : any):any{
    return this.httpClient.get('Stock/webapi/myresource/getNSE/' + date);
  }

  getBse(date : any):any{
    return this.httpClient.get('Stock/webapi/myresource/getBSE/' + date);
  }

  getStock(name : any,date : any):any{
    return this.httpClient.get('Stock/webapi/myresource/getCompanyStock/' + name + '/' + date);
  }
}
